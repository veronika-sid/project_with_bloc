            ...
            children: [
              ...
              Container(
                margin: EdgeInsets.only(
                  bottom: context.getScalableHeight(15),
                ),
                ...
                child: TextFormField(
                  autovalidateMode: AutovalidateMode.always, controller: _email,
              ...
              Container(
                ...
                child: TextFormField(
                  autovalidateMode: AutovalidateMode.always, controller: _password,
                  validator: (value) => state is FormValidateErrorState
                      ? 'Wrong login or password'
                      : null,
                  style: const TextStyle(fontSize: 16),
